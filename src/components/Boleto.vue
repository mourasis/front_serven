    ...
    <div>
        ...
        <div class="headerBtn" id="headerBtn">
            <div style="text-align:right;">
                ...
                <button class="no-print btnDefault print"
                    onclick="window.location='./boleto?fmt=pdf&id={{bsonMongoToString .View.ID}}&pk={{.View.PublicKey}}'">
        ...
        <div class="document">
            <table cellspacing="0" cellpadding="0">
                <tr class="topLine">
                    <td class="bankLogo">
                        <img src="@/assets/caixa-logo-4.png" width="150" alt="">
                    </td>
            ...
            <table cellspacing="0" cellpadding="0" border="1">
                <tr>
                    <td width="70%" colspan="6">
                        ...
                        <br />
                        <span class="text">ATÉ O VENCIMENTO EM QUALQUER BANCO OU CORRESPONDENTE NÃO BANCÁRIO, APÓS O
                            VENCIMENTO, PAGUE EM QUALQUER BANCO OU CORRESPONDENTE NÃO BANCÁRIO</span>
                    </td>
                    <td width="30%">
                ...
                <tr>
                    <td colspan="6" rowspan="4">
                        <span class="title">Instruções de responsabilidade do BENEFICIÁRIO. Qualquer dúvida sobre este
                ...
                <tr>
                    <td colspan="7">
                        <table border="0" style="border:none">
                            ...
                            <tr>
                                <td><span class="text"><b>Endereço: </b> Avenida Brasil 1234 - Jardim Brasil - São Paulo -
                                        SP - 9999999-999</span></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
